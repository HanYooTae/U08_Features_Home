...
FReply FDetailsButton::OnClicked_SaveVertexData()
{
	...
	FPositionVertexBuffer& positionBuffer = lod.VertexBuffers.PositionVertexBuffer;	// 정점 데이터
	FStaticMeshVertexBuffer& metaBuffer = lod.VertexBuffers.StaticMeshVertexBuffer;	// UV, Normal, Tangent etc.
